...
public class HomePageTest extends BaseTest
{
        ...
        @Test(priority = 8)
        public void validatedirectory(){oo.validatedirectory();}
        @Test(priority = 9)
        public void validatemaintenance(){oo.validatemaintenance();}
        @Test(priority = 10)
        public void validatebuzz(){oo.validatebuzz();}
        @Test(priority = 11)
        public void validatelogout(){oo.logout();}
